<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="房间编号" prop="fangjianbianhao">
            <el-input v-model="ruleForm.fangjianbianhao" 
                placeholder="房间编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fangjianbianhao" label="房间编号" prop="fangjianbianhao">
              <el-input v-model="ruleForm.fangjianbianhao" 
                placeholder="房间编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="房间价格" prop="fangjianjiage">
          <el-input v-model="ruleForm.fangjianjiage" 
              placeholder="房间价格" clearable  :readonly="ro.fangjianjiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="房间价格" prop="fangjianjiage">
              <el-input v-model="ruleForm.fangjianjiage" 
                placeholder="房间价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="房间描述" prop="fangjianmiaoshu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="房间描述"
                  v-model="ruleForm.fangjianmiaoshu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fangjianmiaoshu" label="房间描述" prop="fangjianmiaoshu">
                    <span>{{ruleForm.fangjianmiaoshu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fangjianjiage = true;
          ...
          if(o=='fangjianmiaoshu'){
            this.ruleForm.fangjianmiaoshu = obj[o];
	    this.ro.fangjianmiaoshu = true;
            continue;
          }
          if(o=='tupian'){
